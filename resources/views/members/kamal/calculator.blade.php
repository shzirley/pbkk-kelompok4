...
<section class="page-content calculator-page">
    ...
    <div class="calculator-layout">
        <form class="calculator-form" method="GET" action="{{ route('kamal.calculator.submit') }}">
            ...
            <div class="form-actions"><button class="pill-button" type="submit">Hitung hasilnya <span aria-hidden="true">↗</span></button><a class="text-link" href="{{ route('kamal.calculator') }}">Reset</a></div>
        </form>
        <div class="calculation-output" aria-live="polite">
            ...
            @else<span class="result-symbol" aria-hidden="true">=</span><h2>A little clarity,<br><em>one calculation away.</em></h2><p>Isi angka di samping untuk melihat hasilnya di sini.</p><a class="text-link" href="{{ route('kamal.calculate', ['angka1'=>10, 'angka2'=>5, 'operasi'=>'kali']) }}">Coba 10 × 5 ↗</a>@endif
        </div>
    </div>
</section>
@endsection
